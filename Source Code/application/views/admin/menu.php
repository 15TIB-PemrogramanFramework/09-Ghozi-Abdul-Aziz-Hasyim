      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 mr-auto">
            <img class="img-fluid" src="<?php echo base_url()."assets1/"; ?>img/ipad.png" alt="">
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto order-lg-1">
            <img class="img-fluid" src="<?php echo base_url()."assets1/"; ?>img/dog.png" alt="">
          </div>
        </div>
    ...
    <section class="content-section-a">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-auto ">
            <img class="img-fluid" src="<?php echo base_url()."assets1/"; ?>img/phones.png" alt="">
          </div>
        </div>
